...
# =====================================================
# Ambil pilihan dropdown langsung dari data processed
# (biar opsi selalu valid, sesuai isi dataset kamu)
# =====================================================
@st.cache_data
def load_options():
...
st.caption("Frontend ini memanggil FastAPI — model tidak di-load di sini.")
...
if submitted:
    ...
    try:
        with st.spinner("Bertanya ke model..."):
        ...
        with st.expander("Lihat response JSON mentah dari API"):
            st.json(result)

    except requests.ConnectionError:
        st.error("🚨 API tidak terjangkau! Pastikan server uvicorn (port 8000) masih jalan.")
